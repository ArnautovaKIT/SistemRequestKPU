...
namespace SistemRequestKPU.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public AccountController(IAuthService authService, ApplicationDbContext context, IConfiguration configuration)
        {
        ...
        public async Task<IActionResult> RefreshToken([FromBody] RefreshTokenDTO refreshDto)
        {
            ...
            .Select(u => new { u.Id, u.Username, RoleName = u.Role.ToString() })
            .FirstOrDefaultAsync();
